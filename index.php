...
<html>
	...
	<body>
		...
		<div id="subm0" class="div_sub_menu" onmouseover="setHiddenValue('subm0hiddenflag','false');" onmouseout="setHiddenValue('subm0hiddenflag','true');setTimeout('hiddensubMenu(\'subm0\')',t_time);">
			<table width="100%">
				<tr><td class="submenuitem submenutext" onmouseover="this.style.backgroundColor='red';"onmouseout="this.style.backgroundColor='';" onclick="urlredirect('page/page.php?url=cars.php');">婚车</td></tr>
